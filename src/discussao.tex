...
português brasileiro, existem ao menos dois possíveis synsets que revestem o
mesmo conceito: \synset{escova} e \synset{pincel}. A dificuldade deriva do fato
que, em português, o conceito é bipartido em função do uso das escovas e
pincéis; podemos pensar que escovas \emph{limpam} ao passo que pincéis
\emph{espalham} (tinta, claras de ovos etc.). No inglês, essa diferenciação
...
presente na \wnbr , temos, por fim, o alinhamento por~\eqhypo, exemplificado na
figura~\ref{dedo}.
...
O synset \synset{arado} foi alinhado dessa maneira a~\synset{\en{bull tongue}},
